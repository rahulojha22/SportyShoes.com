...
<div class="div-2">
	...
	<a href="AddShoes.jsp"><p style="color:blue;"><h3>Add New Shoes</h3></p></a>
	</td></tr><tr><td style='text-align: center'>
	<a href="UpdateShoes.jsp"><p style="color:blue;"><h3>Update Shoes</h3></p></a>
	</td></tr><tr><td style='text-align: center'>
	<a href="ShoesList"><p style="color:blue;"><h3>List of Shoes</h3></p></a>
	</td></tr><tr><td style='text-align: center'>
	<a href="DeleteShoe.jsp"><p style="color:blue;"><h3>Delete Shoes</h3></p></a>
	</td></tr><tr><td style='text-align: center'>
