...
<div class="div-1" style="height:150px;">
	...
	<h2>Change Passowrd Page</h2>
	</td></table>
</div>
<div class="div-2">
<form action="SetUserPass" method="post" align="center">
	<table border="1" align="center" bgcolor="cyan">
		<tr><td>Username:</td><td><input type="text" name="username" required="required"></td></tr>
		<tr><td>Mobile Number:</td><td><input type="number" name="Unum" required="required"></td></tr>
		<tr><td>New Password:</td><td><input type="text" name="pass" required="required"></td></tr>
	</table>
